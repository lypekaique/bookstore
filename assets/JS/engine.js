...
async function submitFormWithAnimation(event) {
    ...
    elements.welcomeMessage.textContent = `Bem-vindo, ${elements.nome || 'visitante'}!`;
    ...
    elements.welcomeName.textContent = elements.nome || 'Visitante';
    
    // Garante que o main-content está visível
    elements.mainContent.style.display = 'block';
    elements.mainContent.style.visibility = 'visible';
    
    // 7. Anima a entrada da página principal
    await wait(10); // Pequeno delay para renderização
    elements.mainPage.style.opacity = '1';
    await wait(500); // Tempo da animação de fadeOut do formLead
    
    // 8. Anima cada seção individualmente
    ...
    // 9. Remove o formulário completamente
